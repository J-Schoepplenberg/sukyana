use crate::{
    errors::ScannerError,
    networking::{interface::Interface, osi_layers::DatalinkLayer, tcp::Tcp},
};
use anyhow::Result;
use pnet::packet::{ethernet::EtherTypes, tcp::TcpFlags};
use std::net::IpAddr;

/// Sends a `number_of_packets` amount of TCP packets to the specified destination.
///
